...
{
	triposes[base_tp + 0] = lin_interp(p1,p2,f1,f2)/u_blocksize*2 - 1;
	triposes[base_tp + 1] = lin_interp(p1,p3,f1,f3)/u_blocksize*2 - 1;
	triposes[base_tp + 2] = lin_interp(p1,p4,f1,f4)/u_blocksize*2 - 1;
...
{
	triposes[base_tp + 0] = lin_interp(p1,p3,f1,f3)/u_blocksize*2 - 1;
	triposes[base_tp + 1] = lin_interp(p2,p3,f2,f3)/u_blocksize*2 - 1;
	triposes[base_tp + 2] = lin_interp(p1,p4,f1,f4)/u_blocksize*2 - 1;
	triposes[base_tp + 3] = triposes[base_tp + 2];
	triposes[base_tp + 4] = triposes[base_tp + 1];
	triposes[base_tp + 5] = lin_interp(p2,p4,f2,f4)/u_blocksize*2 - 1;
